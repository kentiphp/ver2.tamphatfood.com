    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box box-info">
                ...
                <form action="{{ route('expense.update',$expense) }}" method="POST" class="form-horizontal">
                    @csrf
                    {!! method_field('patch') !!}
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="content" class="form-control" value="{{ $expense->content }}">
                                @error('code')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" oninput="myfuntion()"  id="price" name="price" class="form-control" value="{{ $expense->price }}">
                                @error('code')
                                <span class="invalid-feedback" role="alert">
                                        <strong style="color: red">{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input oninput="myfuntion()" id="quantity" type="text" name="quantity" class="form-control" value="{{ $expense->quantity }}" >
                                @error('code')
                                <span class="invalid-feedback" role="alert">
                                        <strong style="color: red">{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="total" name="total" class="form-control" value="{{ $expense->total }}" readonly  >
                                @error('code')
                                <span class="invalid-feedback" role="alert">
                                        <strong style="color: red">{{ $message }}</strong>
                                    </span>
